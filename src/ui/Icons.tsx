...
// Линейные иконки 24×24, штрих 2px — единое семейство по дизайн-системе.
const paths: Record<string, ReactNode> = {
  ...
  market: <path d="M3 17l6-6 4 4 8-8M15 7h6v6" />,
  clock: (
    <>
  ...
  help: (
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M9.5 9.5a2.5 2.5 0 1 1 3.5 2.3c-.7.3-1 .9-1 1.6v.3M12 17h.01" />
    </>
  ),
  ...
  arrowUp: <path d="M12 20V6M6 12l6-6 6 6" />,
  file: (
    <>
  ...
  medal: (
    <>
      ...
      <path d="M8.5 9.2 6 3h4l2 4 2-4h4l-2.5 6.2M12 11.5l.9 1.8 2 .3-1.4 1.4.3 2-1.8-1-1.8 1 .3-2-1.4-1.4 2-.3z" />
    </>
  ),
  trophy: (
    <>
      <path d="M8 4h8v5a4 4 0 0 1-8 0zM8 6H5a3 3 0 0 0 3 4M16 6h3a3 3 0 0 1-3 4M12 13v4M8 21h8M9 17h6v4H9z" />
    </>
  ),
  cap: (
    <>
  ...
  wallet: (
    <>
      <path d="M4 7h15a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V6a2 2 0 0 1 2-2h11" />
      <path d="M16 13.5h.01" />
    </>
  ),
  card: (
  ...
  trend: <path d="M6 17 17 6M9 6h8v8" />,
  eye: (
    <>
  ...
  eyeOff: (
    <>
      <path d="M3 3l18 18M10.6 5.2A10.4 10.4 0 0 1 12 5c6.4 0 10 7 10 7a17.7 17.7 0 0 1-3.2 4.2M6.6 6.6C3.6 8.5 2 12 2 12s3.6 7 10 7c1.4 0 2.6-.3 3.7-.8" />
